...
cljs.core.async.impl.dispatch.queued_QMARK_ = false;
var count_16668 = (0);while(true){
var m_16669 = cljs.core.async.impl.dispatch.tasks.pop();if((m_16669 == null))
{} else
{m_16669.call(null);
if((count_16668 < cljs.core.async.impl.dispatch.TASK_BATCH_SIZE))
{{
var G__16670 = (count_16668 + (1));
count_16668 = G__16670;
continue;
}
} else
{}
...
{}
cljs.core.async.impl.dispatch.queue_dispatcher = (function queue_dispatcher(){if(cljs.core.truth_((function (){var and__7859__auto__ = cljs.core.async.impl.dispatch.queued_QMARK_;if(and__7859__auto__)
