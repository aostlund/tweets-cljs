...
goog.require('cljs.core.async.impl.protocols');
cljs.core.async.impl.channels.box = (function box(val){if(typeof cljs.core.async.impl.channels.t16674 !== 'undefined')
{} else
{
/**
* @constructor
*/
cljs.core.async.impl.channels.t16674 = (function (val,box,meta16675){
this.val = val;
this.box = box;
...
cljs.core.async.impl.channels.t16674.cljs$lang$type = true;
cljs.core.async.impl.channels.t16674.cljs$lang$ctorStr = "cljs.core.async.impl.channels/t16674";
cljs.core.async.impl.channels.t16674.cljs$lang$ctorPrWriter = (function (this__8438__auto__,writer__8439__auto__,opt__8440__auto__){return cljs.core._write.call(null,writer__8439__auto__,"cljs.core.async.impl.channels/t16674");
});
cljs.core.async.impl.channels.t16674.prototype.cljs$core$IDeref$_deref$arity$1 = (function (_){var self__ = this;
var ___$1 = this;return self__.val;
});
cljs.core.async.impl.channels.t16674.prototype.cljs$core$IMeta$_meta$arity$1 = (function (_16676){var self__ = this;
var _16676__$1 = this;return self__.meta16675;
});
cljs.core.async.impl.channels.t16674.prototype.cljs$core$IWithMeta$_with_meta$arity$2 = (function (_16676,meta16675__$1){var self__ = this;
var _16676__$1 = this;return (new cljs.core.async.impl.channels.t16674(self__.val,self__.box,meta16675__$1));
});
cljs.core.async.impl.channels.__GT_t16674 = (function __GT_t16674(val__$1,box__$1,meta16675){return (new cljs.core.async.impl.channels.t16674(val__$1,box__$1,meta16675));
});
}
return (new cljs.core.async.impl.channels.t16674(val,box,null));
});
...
cljs.core.async.impl.channels.PutBox.cljs$lang$ctorPrWriter = (function (this__8441__auto__,writer__8442__auto__,opts__8443__auto__){return cljs.core._write.call(null,writer__8442__auto__,"cljs.core.async.impl.channels/PutBox");
});
...
cljs.core.async.impl.channels.ManyToManyChannel.cljs$lang$ctorPrWriter = (function (this__8438__auto__,writer__8439__auto__,opt__8440__auto__){return cljs.core._write.call(null,writer__8439__auto__,"cljs.core.async.impl.channels/ManyToManyChannel");
});
...
{self__.closed = true;
while(true){
var taker_16677 = self__.takes.pop();if((taker_16677 == null))
{} else
{if(cljs.core.async.impl.protocols.active_QMARK_.call(null,taker_16677))
{var take_cb_16678 = cljs.core.async.impl.protocols.commit.call(null,taker_16677);cljs.core.async.impl.dispatch.run.call(null,((function (take_cb_16678,taker_16677,this$__$1){
return (function (){return take_cb_16678.call(null,null);
});})(take_cb_16678,taker_16677,this$__$1))
);
} else
{}
{
